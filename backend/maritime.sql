...
(6, 'resumes/sara.pdf', CURRENT_TIMESTAMP()),
(7, 'resumes/esha.pdf', CURRENT_TIMESTAMP()),
(8, 'resumes/abdullah.pdf', CURRENT_TIMESTAMP()),
(9, 'resumes/juweriakazmi.pdf', CURRENT_TIMESTAMP()),
(10, 'resumes/kiran.pdf', CURRENT_TIMESTAMP());
