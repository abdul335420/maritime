            ...
            return (
              <div key={programDetail.program_id}>
                ...
                <ul className="text-left">
                  <li>
                    Internet access - users will need a device with a web
                    browser and internet connection
                  </li>
                  <li>
                    System - runs on computers, tablets and mobile devices using
                    Windows 7 and above and MAC OS devices running IOS 11 and
                    above
                  </li>
                  <li>Browsers - Edge, Chrome, Firefox and Safari</li>
                  <li>Minimum browser size - none</li>
                  <li>Audio - requires device speaker or headphones</li>
                </ul>
                ...
                <div style={{ marginBottom: "5%" }}>
                  ...
                  <iframe
                    src={
                      "http://localhost:8000/" +
                      programDetail.content.split(",")[0]
                    }
                    style={{ width: "100%", height: "700px" }}
                  ></iframe>
                  <button
                    onClick={(e) => {
                      createProgress(programDetail);
                    }}
