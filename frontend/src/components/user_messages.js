...
export default function ClientMessages(){
    ...
    const user_id = localStorage.getItem("user_id")
      ...
      async function submitMessage(id){
        /*
the following code was used for email input. when user types email manually in the input field
  ...
  <select className='form-control' onChange={handleMsgChange} id="user_id" name="user_id" placeholder="Enter email" required >
